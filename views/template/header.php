    ...
    <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapseAlt">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://descomplicazap.com/<?=getStore()->slug;?>" target="_blank">Cardápio <i class="zmdi zmdi-arrow-right"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://descomplicazap.com/<?=getStore()->slug;?>" target="_blank">Mesas <i class="zmdi zmdi-arrow-right"></i></a>
                </li>
            </ul>
        </div>
